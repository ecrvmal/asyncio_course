...
async def main():
    ...
    r1 = await asyncio.ensure_future(first_function(1))
    r2 = await asyncio.ensure_future(second_function(r1))
    r3 = await asyncio.ensure_future(third_function(r2))
    final_result = await asyncio.ensure_future(fourth_function(r3))
